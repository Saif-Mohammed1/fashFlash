...
import Refunds from "@/component/admin-dashboard/refunds";
...
export const metadata = {
  ...
  description: "Refunds Management Dashboard",
};
...
const Page = async ({ searchParams }) => {
  try {
    ...
    return (
      <>
        {" "}
        <Refunds data={data || []} title="Refunds" />
